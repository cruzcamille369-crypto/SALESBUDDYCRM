...
export interface DataHealthAction {
    id: string;
    type: 'flag_user' | 'merge_contact' | 'clean_stale' | 'examine_conflict' | 'archive_contact' | 'enrich_contact';
    targetId: string;
    targetName: string;
    metadata?: any;
}
...
export interface IncentiveSettings {
    ...
    minimumPayoutThreshold: number;
    spiffRules: SpiffRule[];
    requiredHoursForCutoff: number;
    disqualifyIfLate: boolean;
    disqualifyIfBelowCutoffHours: boolean;
    spiffTiering: SpiffTier[];
    updatedAt?: number;
    createdAt?: number;
}
